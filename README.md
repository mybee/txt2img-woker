...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/txt2img-woker
```

A live public deployment of this template is available at [https://txt2img-woker.templates.workers.dev](https://txt2img-woker.templates.workers.dev)
